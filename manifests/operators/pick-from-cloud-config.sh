...
# The base manifests/avalanche.yml assumes that your `bosh cloud-config` contains
...
#
# Usage:
#   bosh deploy manifests/avalanche.yml -o <(./manifests/operators/pick-from-cloud-config.sh)
